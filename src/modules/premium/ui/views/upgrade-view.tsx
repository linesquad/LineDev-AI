      ...
      <div className="mt-4 flex-1 flex flex-col gap-y-10 items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {products.map((product) => {
            ...
            const isPremiumPlan = !!currentSubscription;
...
export const UpgradeViewLoading = () => {
  return (
    <LoadingState
      title="Loading"
      description="Loading your subscription, this may take a few seconds"
    />
  );
};
...
export const UpgradeViewError = () => {
  return (
    <ErrorState
      title="Error"
      description="Error loading your subscription, please try again later"
    />
  );
};
